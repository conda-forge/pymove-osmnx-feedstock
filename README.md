About pymove-osmnx-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymove-osmnx-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11814&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymove-osmnx-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymove-osmnx` can be installed with `conda`:
...
```
mamba install pymove-osmnx
```

It is possible to list all of the versions of `pymove-osmnx` available on your platform with `conda`:
...
```
mamba search pymove-osmnx --channel conda-forge
```
...
mamba repoquery search pymove-osmnx --channel conda-forge

# List packages depending on `pymove-osmnx`:
mamba repoquery whoneeds pymove-osmnx --channel conda-forge

# List dependencies of `pymove-osmnx`:
mamba repoquery depends pymove-osmnx --channel conda-forge
```
